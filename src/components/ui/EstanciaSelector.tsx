    ...
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      >
        <div className="flex items-center space-x-2 truncate">
          ...
          <div className="text-left truncate max-w-[130px] sm:max-w-[180px]">
      ...
      {estaAbierto && (
        <div className="absolute right-0 mt-2 w-72 sm:w-80 rounded-2xl bg-slate-900/98 backdrop-blur-xl border border-emerald-800/60 shadow-2xl z-50 p-2 space-y-1 animate-in fade-in slide-in-from-top-2 duration-150">
          ...
          {tieneAccesoTodas && (
            ...
            >
              <div className="flex items-center space-x-2.5">
                <div className={`p-2 rounded-lg ${estanciaSeleccionadaId === 'TODOS' ? 'bg-emerald-600 text-white' : 'bg-slate-800 text-slate-400'}`}>
